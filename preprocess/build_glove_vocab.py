...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_paths', default=['data/Spider/train.bin'], nargs='+', type=str, help='input preprocessed dataset file')
    parser.add_argument('--table_path', default='data/Spider/tables.bin', type=str, help='preprocessed table file')
    parser.add_argument('--output_path', default='pretrained_models/glove.42b.300d/vocab.txt', type=str, help='output word vocabulary path')
