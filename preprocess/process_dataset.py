...
def process_dataset(processor, dataset, tables, output_path=None, skip_large=False, verbose=False):
    from utils.constants import GRAMMAR_FILEPATH    # TODO
...
if __name__ == '__main__':
    ...
    # arg_parser.add_argument('--dataset_path', default='data/Spider/train.json', type=str, help='dataset path')
    arg_parser.add_argument('--dataset_path', default='data/Spider/dev.json', type=str, help='dataset path')
    # arg_parser.add_argument('--raw_table_path', default='data/Spider/tables.json', type=str, help='raw tables path')
    arg_parser.add_argument('--raw_table_path', default='', type=str, help='raw tables path')
    arg_parser.add_argument('--table_path', default='data/Spider/tables.bin', type=str, help='processed table path')
    # arg_parser.add_argument('--output_path', default='data/Spider/train.bin', type=str, help='output preprocessed dataset')
    arg_parser.add_argument('--output_path', default='data/Spider/dev.bin', type=str, help='output preprocessed dataset')
    # arg_parser.add_argument('--skip_large', action='store_true', help='whether skip large databases')
    arg_parser.add_argument('--skip_large', default=True, action='store_true', help='whether skip large databases') # TODO
    ...
    # processor = Preprocessor(db_dir=args.db_dir, db_content=False)   # TODO
