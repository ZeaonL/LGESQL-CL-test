...
if __name__ == '__main__':
    ...
    # arg_parser.add_argument('--dataset_path', default='data/Spider/train.bin', type=str, help='dataset path')
    arg_parser.add_argument('--dataset_path', default='data/Spider/dev.bin', type=str, help='dataset path')
    arg_parser.add_argument('--table_path', default='data/Spider/tables.bin', type=str, help='processed table path')
    arg_parser.add_argument('--method', default='rgatsql', type=str, choices=['rgatsql', 'lgesql'])
    # arg_parser.add_argument('--output_path', default='data/Spider/train.rgatsql.bin', type=str, help='output preprocessed dataset')
    arg_parser.add_argument('--output_path', default='data/Spider/dev.rgatsql.bin', type=str, help='output preprocessed dataset')
