...
from pretrained_models.bert_cn import tokenization
tokenizer = tokenization.FullTokenizer(
    vocab_file='pretrained_models/bert_cn/vocab.txt', do_lower_case=True)
...
class Preprocessor():
    ...
    def __init__(self, db_dir='data/database', db_content=True):
        ...
        # self.nlp = stanza.Pipeline(lang='zh')  # TODO
        self.stopwords = stopwords.words("english")
        # self.stopwords = stopwords.words("chinese") # TODO 
    ...
    def preprocess_database(self, db: dict, verbose: bool = False):
        ...
        for tab in db['table_names']:
            ...
            # tab = tokenizer.tokenize(tab)    # TODO
            table_toks.append(tab)
            table_names.append(" ".join(tab))
            # table_names.append("".join(tab))   # TODO
        ...
        for _, c in db['column_names']:
            ...
            # c = tokenizer.tokenize(c)   # TODO
            column_toks.append(c)
            column_names.append(" ".join(c))
            # column_names.append("".join(c))    # TODO
    ...
    def schema_linking(self, entry: dict, db: dict, verbose: bool = False):
        ...
        for i, j in index_pairs:
            ...
            # phrase = ''.join(question_toks[i: j])  # TODO
